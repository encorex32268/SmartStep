...
@Composable
fun EnableAccessManuallyBottomSheet(
    openSettings: () -> Unit,
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.enable_access_manually_step1),
                style = MaterialTheme.typography.bodyLarge.copy(
                    color = MaterialTheme.colorScheme.onBackground,
            ...
            Text(
                text = stringResource(R.string.enable_access_manually_step2),
                style = MaterialTheme.typography.bodyLarge.copy(
                    color = MaterialTheme.colorScheme.onBackground,
                    fontWeight = FontWeight.Medium
                )
            ...
            Text(
                text = stringResource(R.string.enable_access_manually_step3),
                style = MaterialTheme.typography.bodyLarge.copy(
                    color = MaterialTheme.colorScheme.onBackground,
                    fontWeight = FontWeight.Medium
                )
...
@Composable
private fun EnableAccessManuallyBottomSheetPreview() {
    SmartStepTheme {
